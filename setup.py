...
from ashar.__version__ import __version__,__name__,__author__,__author_email__,__description__,__Author_WebSite__,__Source_Code__,__keywords__,__install_requires__,__license__,__copyright__,__README_MD__title__,__README_MD__description__,__README_MD__Installation__,__README_MD__changelog__,__travis__install__,__travis__script__
